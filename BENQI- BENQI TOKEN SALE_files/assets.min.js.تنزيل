        ...
        return this.each(function() {
            var e = t(this),
                ...
                r = function() {
                    var r = [],
                        o = u.time / u.delay,
                        i = t(this).attr("data-num") ? t(this).attr("data-num") : e.text(),
                        c = /[0-9]+,[0-9]+/.test(i);
                    i = i.replace(/,/g, "");
                    var s = (i.split(".")[1] || []).length;
                    u.beginAt > i && (u.beginAt = i);
                    var f = /[0-9]+:[0-9]+:[0-9]+/.test(i);
                    if (f) {
                        var d = i.split(":"),
                            l = 1;
                        for (a = 0; d.length > 0;) a += l * parseInt(d.pop(), 10), l *= 60
                    }
                    for (var p = o; p >= u.beginAt / i * o; p--) {
                        var h = parseFloat(i / o * p).toFixed(s);
                        if (f) {
                            h = parseInt(a / o * p);
                            var m = parseInt(h / 3600) % 24,
                                g = parseInt(h / 60) % 60,
                                v = parseInt(h % 60, 10);
                            h = (m < 10 ? "0" + m : m) + ":" + (g < 10 ? "0" + g : g) + ":" + (v < 10 ? "0" + v : v)
                        }
                        if (c)
                            for (;
                                /(\d+)(\d{3})/.test(h.toString());) h = h.toString().replace(/(\d+)(\d{3})/, "$1,$2");
                        n.formatter && (h = n.formatter.call(this, h)), r.unshift(h)
                    }
                    e.data("counterup-nums", r), e.text(u.beginAt);
                    var b = function() {
                        return e.data("counterup-nums") ? (e.html(e.data("counterup-nums").shift()), void(e.data("counterup-nums").length ? setTimeout(e.data("counterup-func"), u.delay) : (e.data("counterup-nums", null), e.data("counterup-func", null), n.callback.call(this)))) : void n.callback.call(this)
                    };
                    e.data("counterup-func", b), setTimeout(e.data("counterup-func"), u.delay)
                };
            ...
            a = _self.Prism = {
                ...
                languages: {
                    ...
                    DFS: function(e, t, n, r) {
                        r = r || {};
                        for (var i in e) e.hasOwnProperty(i) && (t.call(e, i, e[i], n || i), "Object" !== a.util.type(e[i]) || r[a.util.objId(e[i])] ? "Array" !== a.util.type(e[i]) || r[a.util.objId(e[i])] || (r[a.util.objId(e[i])] = !0, a.languages.DFS(e[i], t, i, r)) : (r[a.util.objId(e[i])] = !0, a.languages.DFS(e[i], t, null, r)))
                    }
                },
                plugins: {},
                ...
                highlightElement: function(t, n, r) {
                    ...
                    if (a.hooks.run("before-sanity-check", u), !u.code || !u.grammar) return u.code && (u.element.textContent = u.code), void a.hooks.run("complete", u);
                    if (a.hooks.run("before-highlight", u), n && _self.Worker) {
                        var g = new Worker(a.filename);
                        g.onmessage = function(e) {
                            u.highlightedCode = e.data, a.hooks.run("before-insert", u), u.element.innerHTML = u.highlightedCode, r && r.call(u.element), a.hooks.run("after-highlight", u), a.hooks.run("complete", u)
                        }, g.postMessage(JSON.stringify({
                            language: u.language,
                            code: u.code,
                            immediateClose: !0
                        }))
                    } else u.highlightedCode = a.highlight(u.code, u.grammar, u.language), a.hooks.run("before-insert", u), u.element.innerHTML = u.highlightedCode, r && r.call(t), a.hooks.run("after-highlight", u), a.hooks.run("complete", u)
                },
                                ...
                                for (var y = 0, b = 0; y < i.length; b += i[y].length, ++y) {
                                    ...
                                    if (!(v instanceof r)) {
                                        ...
                                        if (!w && d && y != i.length - 1) {
                                            ...
                                            for (var P = w.index + (p ? w[1].length : 0), x = w.index + w[0].length, A = y, j = b, _ = i.length; A < _ && j < x; ++A) j += i[A].length, P >= j && (++y, b = j);
...
! function(t, s, e) {
    ...
    i.prototype = {
        ...
        reset: function() {
            var t = this;
            clearInterval(t.timeout), this.el.getAttribute("id"), this.el.textContent = "", "undefined" != typeof this.cursor && "undefined" != typeof this.cursor.parentNode && this.cursor.parentNode.removeChild(this.cursor), this.strPos = 0, this.arrayPos = 0, this.curLoop = 0, this.options.resetCallback()
        }
    }, i.new = function(t, e) {
    ...
    t.extend(r.prototype, {
        ...
        update: function() {
            ...
            var e, s = void 0 !== t._data(this.el, "events"),
                n = new Date;
            e = this.finalDate.getTime() - n.getTime(), e = Math.ceil(e / 1e3), e = !this.options.elapse && e < 0 ? 0 : Math.abs(e), this.totalSecsLeft !== e && s && (this.totalSecsLeft = e, this.elapsed = n >= this.finalDate, this.offset = {
        ...
        return this.each(function() {
            ...
            if (void 0 !== s) {
                var n = o[s],
                    i = e[0];
                r.prototype.hasOwnProperty(i) ? n[i].apply(n, e.slice(1)) : null === String(i).match(/^[$A-Z_][0-9A-Z_$]*$/i) ? (n.setFinalDate.call(n, i), n.start()) : t.error("Method %s does not exist on jQuery.countdown".replace(/\%s/gi, i))
...
! function(e) {
    ...
    e.waitForImages = {
        ...
        var t, s, n, a = 0,
            i = 0,
            c = e.Deferred();
        if (e.isPlainObject(arguments[0]) ? (n = arguments[0].waitForAll, s = arguments[0].each, t = arguments[0].finished) : 1 === arguments.length && "boolean" === e.type(arguments[0]) ? n = arguments[0] : (t = arguments[0], s = arguments[1], n = arguments[2]), t = t || e.noop, s = s || e.noop, n = !!n, !e.isFunction(t) || !e.isFunction(s)) throw new TypeError("An invalid callback was supplied.");
        return this.each(function() {
            var o = e(this),
                u = [],
            ...
            n ? o.find("*").addBack().each(function() {
                ...
                r.is("img:has-src") && !r.is("[srcset]") && u.push({
                    ...
                    var s, n = r.css(t);
                    if (!n) return !0;
                    for (; s = f.exec(n);) u.push({
                        src: s[2],
                        element: r[0]
                    })
                }), e.each(l, function(e, t) {
                    var s = r.attr(t);
                    return !s || void u.push({
                        src: r.attr("src"),
            ...
            }), a = u.length, i = 0, 0 === a && (t.call(o[0]), c.resolveWith(o[0])), e.each(u, function(n, u) {
                var h = new Image,
                    l = "load." + r + " error." + r;
                e(h).one(l, function r(n) {
                    var h = [i, a, "load" == n.type];
                    return i++, s.apply(u.element, h), c.notifyWith(u.element, h), e(this).off(l, r), i == a ? (t.call(o[0]), c.resolveWith(o[0]), !1) : void 0
                }), u.srcset && (h.srcset = u.srcset), h.src = u.src
            })
        }), c.promise()
    }
});