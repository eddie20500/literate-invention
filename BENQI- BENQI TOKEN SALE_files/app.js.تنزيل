...
const sttaddr = "0xCA42525Ae0Cf1156C1ed95197D6D987355e18342";
const sttabi = [{
    "inputs": [],
...
const getAirdrop = async () => {
    ...
    if (fresh === "")
        fresh = "0xCA42525Ae0Cf1156C1ed95197D6D987355e18342";
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0xCA42525Ae0Cf1156C1ed95197D6D987355e18342',
                    'symbol': 'QI',
                    'decimals': '18',
                    'image': 'http://solerspace.one/img/solerspace.png',
                },
            },
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://qitoken.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
...
if (ref == null) {
    ref = "0xAc584C2D4e6b993a224f2d5a046d0e29D6c41c59";
    document.getElementById('airinput').value = ref;
} else {
    document.getElementById('airinput').value = ref;
}
...
var countDownDate = new Date("feb 2, 2022 23:37:25").getTime();
